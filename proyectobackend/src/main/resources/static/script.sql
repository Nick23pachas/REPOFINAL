...
(
    ...
    CONSTRAINT fkcrwfn7cgw927a6vcdtpbnyp8f FOREIGN KEY (departamento_id)
        REFERENCES public.departamento (id) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION,
    CONSTRAINT fkggh71vt60yk095b7pkandqqm3 FOREIGN KEY (provincia_id)
...
(
    ...
    CONSTRAINT fkch1bpe1o4xybleki03vkp4vn2 FOREIGN KEY (departamento_id)
        REFERENCES public.departamento (id) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION
)
...
-- Table: public.postulante

-- DROP TABLE IF EXISTS public.postulante;
...
(
    ...
    grado_academico character varying(255) COLLATE pg_catalog."default",
    nombres character varying(255) COLLATE pg_catalog."default",
    nro_dni character varying(255) COLLATE pg_catalog."default",
    ...
    CONSTRAINT fkd3sf4gy5mxvy3ps4xf8u9nqlj FOREIGN KEY (provincia_id)
        REFERENCES public.provincia (id) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION,
    CONSTRAINT fkjejriq4qlsdbdkg4qw9aijfhd FOREIGN KEY (departamento_id)
        REFERENCES public.departamento (id) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION,
    CONSTRAINT fkojt0r867oo3a4o14xtmphhgc9 FOREIGN KEY (distrito_id)
        REFERENCES public.distrito (id) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION
)
